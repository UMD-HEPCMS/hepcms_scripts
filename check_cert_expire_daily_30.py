...
GRID_SECURITY_DIRS = ['/data/site_conf/certs/'] #Be sure to have a '/' at the end of any directory in this list

#Checks if /data/site_conf/certs exists
if str(os.path.isdir("/data/site_conf/certs")) == "False" : 
  quit()
